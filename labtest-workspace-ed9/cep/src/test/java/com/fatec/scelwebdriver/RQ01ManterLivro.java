...
public class RQ01ManterLivro {
	...
	@Test
	public void ct01cadastrosucesso() {
	    ...
	    driver.findElement(By.id("isbn")).sendKeys("1238");
	    driver.findElement(By.id("autor")).click();
	    driver.findElement(By.id("autor")).clear();
	    driver.findElement(By.id("autor")).sendKeys("Renatu");
	    driver.findElement(By.id("titulo")).click();
	    driver.findElement(By.id("titulo")).clear();
	    driver.findElement(By.id("titulo")).sendKeys("Ed09 Seleniun");
